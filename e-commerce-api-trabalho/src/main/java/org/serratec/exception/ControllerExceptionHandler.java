...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleDataPedidoAnteriorException(DataPedidoAnteriorException ex) {
		List<ErroCampo> erros = new ArrayList<>();
		erros.add(new ErroCampo("dataPedido", "Data pedido não pode ser anterior a data de hoje."));
