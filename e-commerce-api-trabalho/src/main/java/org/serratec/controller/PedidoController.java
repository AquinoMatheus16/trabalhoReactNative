...
public class PedidoController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Retorna lista de Pedidos"),
	...
	public ResponseEntity<PedidoDTO> cadastrar(@Valid @RequestBody PedidoDTO2 pedido)
		...
		URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(pedidoDTO.getIdPedido())
				.toUri();
